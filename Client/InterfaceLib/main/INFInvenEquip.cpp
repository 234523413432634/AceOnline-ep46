...
CINFInvenEquip::~CINFInvenEquip()
{
	...
	SAFE_DELETE(m_pFontSPIWPToolTip);				// 2013-08-14 by ssjung 캐나다 인벤토리안의 SPI, WP 툴팁 표시			
}
...
{		
	...
	m_pFontSPIWPToolTip->RestoreDeviceObjects();			// 2013-08-14 by ssjung 캐나다 인벤토리안의 SPI, WP 툴팁 표시
	return S_OK;
}
...
#endif
	m_pFontSPIWPToolTip->InvalidateDeviceObjects();			// 2013-08-14 by ssjung 캐나다 인벤토리안의 SPI, WP 툴팁 표시
	return S_OK;
}
...
#endif
	if(!m_bTradeItemCenterState)				  // 2013-11-29 by ssjung 거래소 구현
		RenderSPIWPTooltip();					// 2013-08-14 by ssjung 캐나다 인벤토리안의 SPI, WP 툴팁 표시
